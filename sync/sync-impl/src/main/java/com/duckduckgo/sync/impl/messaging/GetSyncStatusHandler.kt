        ...
        object : JsMessageHandler {
            override fun process(
                ...
                val payload = JSONObject().apply {
                    ...
                    put("userId", if (signedIn) syncStore.userId else JSONObject.NULL)
                    put("deviceId", if (signedIn) syncStore.deviceId else JSONObject.NULL)
                    put("deviceName", if (signedIn) syncStore.deviceName else JSONObject.NULL)
