...
class EncryptWithSyncMasterKeyHandler @Inject constructor(
    ...
    private val featureName: String = "aiChat"
    ...
    override fun getJsMessageHandler(): JsMessageHandler =
        object : JsMessageHandler {
            override fun process(
                ...
                if (data == null) {
                    responder.sendError("Missing 'data' field in params")
                    return
                }
                ...
                if (decodedBytes == null) {
                    responder.sendError("base64URL decode failed")
                    return
                }
                ...
                if (encryptedBytes == null) {
                    responder.sendError("encryption failed")
                    return
                }
                ...
                responder.sendSuccess(encryptedData)
            }
            ...
            override val featureName: String = this@EncryptWithSyncMasterKeyHandler.featureName
    ...
    private class JavaScriptResponder(
        ...
        fun sendSuccess(encryptedData: String) {
