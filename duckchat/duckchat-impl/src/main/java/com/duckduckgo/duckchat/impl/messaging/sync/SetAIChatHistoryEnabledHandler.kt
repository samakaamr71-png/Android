        ...
        object : JsMessageHandler {
            override fun process(
                ...
                appCoroutineScope.launch(dispatchers.io()) {
                    ...
                    logcat(LogPriority.VERBOSE) { "DuckChat-Sync: AI chat history enabled to $enabled" }
                }
            }
